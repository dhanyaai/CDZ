...
async function seed() {
  ...
  const [
    ...
    { companyId: co.id, name: "Executive Diary & Pen Set",     category: "Stationery",         costPrice: "320",  sellingPrice: "550",  stockLevel: 250, lowStockThreshold: 30, vendorId: craftVendor.id },
    { companyId: co.id, name: "Genuine Leather Wallet",        category: "Bags & Accessories", costPrice: "480",  sellingPrice: "850",  stockLevel: 180, lowStockThreshold: 20, vendorId: luxeVendor.id  },
    { companyId: co.id, name: "Wireless Earbuds Pro",          category: "Electronics",        costPrice: "1200", sellingPrice: "1999", stockLevel: 85,  lowStockThreshold: 15, vendorId: techVendor.id  },
    { companyId: co.id, name: "Premium Chocolate Box (18pc)",  category: "Food & Beverage",    costPrice: "250",  sellingPrice: "450",  stockLevel: 320, lowStockThreshold: 50, vendorId: foodVendor.id  },
    { companyId: co.id, name: "Mixed Dry Fruits Tin (500g)",   category: "Food & Beverage",    costPrice: "380",  sellingPrice: "650",  stockLevel: 210, lowStockThreshold: 40, vendorId: foodVendor.id  },
    { companyId: co.id, name: "Indoor Succulent Plant Kit",    category: "Lifestyle",          costPrice: "280",  sellingPrice: "499",  stockLevel: 8,   lowStockThreshold: 20, vendorId: craftVendor.id },
    { companyId: co.id, name: "Branded Hardbound Notebook",    category: "Stationery",         costPrice: "180",  sellingPrice: "320",  stockLevel: 420, lowStockThreshold: 60, vendorId: printVendor.id },
    { companyId: co.id, name: "Ceramic Coffee Mug (Set of 2)", category: "Drinkware",          costPrice: "200",  sellingPrice: "380",  stockLevel: 150, lowStockThreshold: 25, vendorId: craftVendor.id },
    { companyId: co.id, name: "Company-Branded T-Shirt",       category: "Apparel",            costPrice: "300",  sellingPrice: "499",  stockLevel: 5,   lowStockThreshold: 30, vendorId: luxeVendor.id  },
    { companyId: co.id, name: "Canvas Sling Bag",              category: "Bags & Accessories", costPrice: "350",  sellingPrice: "599",  stockLevel: 120, lowStockThreshold: 20, vendorId: luxeVendor.id  },
    { companyId: co.id, name: "Custom Water Bottle 750ml",     category: "Drinkware",          costPrice: "195",  sellingPrice: "360",  stockLevel: 95,  lowStockThreshold: 20, vendorId: craftVendor.id },
    { companyId: co.id, name: "Premium Keychain Set (3pc)",    category: "Bags & Accessories", costPrice: "45",   sellingPrice: "89",   stockLevel: 480, lowStockThreshold: 80, vendorId: printVendor.id },
    { companyId: co.id, name: "Bamboo Pen Stand",              category: "Office Gifts",       costPrice: "175",  sellingPrice: "320",  stockLevel: 130, lowStockThreshold: 25, vendorId: craftVendor.id },
    { companyId: co.id, name: "USB-C Hub 7-in-1",             category: "Electronics",        costPrice: "450",  sellingPrice: "799",  stockLevel: 40,  lowStockThreshold: 10, vendorId: techVendor.id  },
    { companyId: co.id, name: "Premium Gift Wrap Box Set",     category: "Lifestyle",          costPrice: "150",  sellingPrice: "280",  stockLevel: 360, lowStockThreshold: 50, vendorId: printVendor.id },
  ]).returning();
